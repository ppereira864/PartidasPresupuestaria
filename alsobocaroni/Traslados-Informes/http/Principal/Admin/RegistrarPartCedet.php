...
<head>
	<meta charset="UTF-8">
	<title>Registrar Partidas Cedentes</title>
...
<body style="background-image: url('../../../../../img/Apple-Laptop-And-A-Mug-Of-Coffee.jpg'); background-size: cover;">
	...
	<form  action="NewUpdaRestDelt.php?opc=reg_pct" id="Registrandotraslado" method="POST" 
				style="background-color:#8B7777; border-radius:45px; padding: 0px 12px; margin: 18px;">
			
			<center><table>
			<tr><br>
				<td style="color:black;">
					<h5 style="margin: 3px;"> Numero Acuerdo  Año y Mes :</h5>
				</td>
				<td>
		...
		<hr onmouseover="verificar_monto();">
